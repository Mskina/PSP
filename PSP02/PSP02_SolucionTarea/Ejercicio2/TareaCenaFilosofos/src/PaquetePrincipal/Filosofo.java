...
public class Filosofo extends Thread {
     ...
     */
    public Filosofo(int miIndice, Semaphore[] semaforoPalillo,
    ...
    public void pensar() {
        ...
        System.out.println("Filósofo " + (1 + miIndice) + " Pensando");
     ...
     * ' está hambriento', mientras trata de conseguir los dos palillos que
     * necesita para comer. Una vez conseguidos, mostrará un mensaje de que el
     * 'Filósofo ' N ' está comiendo'. Para simular esta actividad, dormirá el
     * hilo un tiempo aleatorio. Cuando termine, mostrará un mensaje de que el
     * 'Filósofo ' N ' ha terminado de comer', indicando los palillos que se
     * quedan libres.
     */
    public void comer() {

        System.out.println("Filósofo " + (1 + miIndice) + " Hambriento");
        ...
        System.out.println("Filósofo " + (1 + miIndice) + " Comiendo");
        ...
        //termina de comer
        System.out.println("Filósofo " + (1 + miIndice) + " Termina de comer. "
                + "Palillos Libres:" + (misPalillos[0] + 1) + ","
                + (misPalillos[1] + 1));
