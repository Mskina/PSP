...
/**
 * Se prueban algunos de los métodos de la clase URLConnection.
 *
 * @author Iván Estévez Sabucedo
 */
public class Ejemplo3URLConnection {
    ...
    public static void main(String[] args) throws Exception {
        String cadena;
        URL url = new URL("https://www.iessanclemente.net");
